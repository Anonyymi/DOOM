...
int mmus2mid(const UBYTE *mus, MIDI *mididata, UWORD division, int nocomp)
{
  ...
  MUSh.ScoreLength = (short int)(MUSh.ScoreLength);
  MUSh.ScoreStart  = (short int)(MUSh.ScoreStart);
  MUSh.channels    = (short int)(MUSh.channels);
  MUSh.SecChannels = (short int)(MUSh.SecChannels);
  MUSh.InstrCnt    = (short int)(MUSh.InstrCnt);
