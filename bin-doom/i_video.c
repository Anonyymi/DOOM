...
#define BYTES_PER_PIXEL (4 * sizeof(char))
...
void I_FinishUpdate (void)
{
    ...
    for (unsigned int y = 0; y < X_height * BYTES_PER_PIXEL; y += BYTES_PER_PIXEL)
    {
        unsigned int y_ = y / BYTES_PER_PIXEL;
...
void I_InitGraphics(void)
{
    ...
    I_Error("xdoom currently only supports 24-bit DirectColor screens");
	...
	image = XCreateImage(	X_display,
                    ...
                    ZPixmap,
    				0,
                    (char*)malloc(X_width * X_height * BYTES_PER_PIXEL),
    				X_width, X_height,
                    8,
